...
def list_files():
    """
        http://127.0.0.1:8080/list_files?bucket_name=comp4312_0696399
    """
    from storage_list_files import return_blobs
    try:
        bucket_name = request.args.get('bucket_name', default='comp4312_0696399', type=str)
...
def create_bk():
    """
        http://127.0.0.1:8080/create_bk?bucket_name=comp4312_00696399
    """
    from storage_create_bucket import create_bucket
    try:
        bucket_name = request.args.get('bucket_name', default='comp4312_00696399')
...
def delete_bk():
    """
        http://127.0.0.1:8080/delete_bk?bucket_name=comp4312_00696399
    """
    from storage_delete_bucket import delete_bucket
    try:
        bucket_name = request.args.get('bucket_name', default='comp4312_00696399')
